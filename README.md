...
- To explore the **EDP project for pricing financial models (Jan 2026)**, see the [`EDP_Project`](https://github.com/zmeikingleb/Financial_Models/tree/EDP_Simulation_Project) branch.
